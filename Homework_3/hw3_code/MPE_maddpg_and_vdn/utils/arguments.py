...
def get_common_args():
    ...
    parser.add_argument("--n_parallel_envs", default=1, type=int, help="The parallel envs to create")
    ...
    parser.add_argument('--algo', type=str, required=True, choices=["maddpg", "vdn"])
