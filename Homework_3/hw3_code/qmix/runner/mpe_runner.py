...
class MPERunner(RecRunner):
    ...
    def shared_collect_rollout(self, explore=True, training_episode=True, warmup=False):
        ...
        env_info['average_episode_rewards'] = average_episode_rewards / 25
    ...
    def separated_collect_rollout(self, explore=True, training_episode=True, warmup=False):
        ...
        for p_id in self.policy_ids:
            average_episode_rewards.append(np.mean(np.sum(episode_rewards[p_id], axis=0))/25)
    ...
    def log(self):
        ...
        print("NO.{}: {} | {} | timesteps: {}/{} | "
              .format(int(self.total_env_steps / self.args.log_interval),
